  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-orange-100">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 font-montserrat drop-shadow-2xl shadow-black">
          Гамарджоба генацвале
        </h1>
        <p className="text-2xl md:text-3xl text-white mb-4 font-open-sans drop-shadow-xl shadow-black">
          Грузинское кафе с душой
        </p>
        <p className="text-lg md:text-xl text-white mb-8 max-w-2xl mx-auto leading-relaxed drop-shadow-lg shadow-black">
